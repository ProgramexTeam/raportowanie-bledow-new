            ...
            <%
                    ...
                    if (!list.isEmpty()) {
                        for (Project project : list) {
                            out.println("<tr class=\"project-row ticket-no-" + i + "\">" +
                                    ...
                                    "<a href=\"" + request.getContextPath() + "/admin/project-manager/edit-project?categoryId=" + project.getId() + "\">edytuj</a> / " +
                                    "<a href=\"" + request.getContextPath() + "/admin/project-manager?page=" + currentPage + "&amountPerPage=" + amountPerPage + "&searchOption=" + searchOption + "&searchByCategoryName=" + searchByCategoryName + "&deleteId=" + project.getId() + "\">usuń</a>" +
                                    "</td>" +
                ...
                if(request.getAttribute("pagesToPrint") != null) {
                    ...
                    if(currentPage<pagesToPrint){
                        ...
                        <% if (pagesToPrint>12) {
                            if (currentPage != 0) {
                                out.println("<a href=\"" + request.getContextPath() + "/admin/project-manager?page=" + (currentPage - 1) + "&amountPerPage=" + amountPerPage + "&searchOption=" + searchOption + "&searchByCategoryName=" + searchByCategoryName + "\">" +
                                        "<div class=\"link-no-0 previous-page\">Poprzednia</div>" +
                                        "</a>");
                            }

                            if(currentPage == 0){
                                out.println("<a href=\"" + request.getContextPath() + "/admin/project-manager?page=0&amountPerPage=" + amountPerPage + "&searchOption=" + searchOption + "&searchByCategoryName=" + searchByCategoryName + "\">" +
                            ...
                            for(int j=currentPage-a; j<=currentPage+b; j++) {
                                if(j==currentPage) {
                                    out.println("<a href=\"" + request.getContextPath() + "/admin/project-manager?page=" + j + "&amountPerPage=" + amountPerPage + "&searchOption=" + searchOption + "&searchByCategoryName=" + searchByCategoryName + "\">" +
                            ...
                            if(currentPage==pagesToPrint-1){
                                out.println("<a href=\"" + request.getContextPath() + "/admin/project-manager?page=" + (pagesToPrint - 1) + "&amountPerPage=" + amountPerPage + "&searchOption=" + searchOption + "&searchByCategoryName=" + searchByCategoryName + "\">" +
