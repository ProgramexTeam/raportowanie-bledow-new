...
@WebServlet("/admin/media-manager-frame")
public class MediaManagerFrame extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("/WEB-INF/admin/media-manager-frame.jsp").forward(request, response);
    }
