            ...
            <%
                    ...
                    if (!list.isEmpty()) {
                        for (Ticket ticket : list) {
                            out.println("<tr class=\"ticket-row ticket-no-" + i + "\">" +
                                    ...
                                    "<a href=\"" + request.getContextPath() + "/user/ticket-manager?page=" + currentPage + "&amountPerPage=" + amountPerPage + "&searchOption=" + searchOption + "&searchByProductName=" + searchByProductName + "&deleteId=" + ticket.getId() + "\">usuń</a>" +
                                    "</td>" +
                ...
                if(request.getAttribute("pagesToPrint") != null) {
                    ...
                    if(currentPage<pagesToPrint){
                        ...
                        <% if (pagesToPrint>12) {
                            if (currentPage != 0) {
                                out.println("<a href=\"" + request.getContextPath() + "/user/ticket-manager?page=" + (currentPage - 1) + "&amountPerPage=" + amountPerPage + "&searchOption=" + searchOption + "&searchByProductName=" + searchByProductName + "\">" +
                                        "<div class=\"link-no-0 previous-page\">Poprzednia</div>" +
                                        "</a>");
                            }

                            if(currentPage == 0){
                                out.println("<a href=\"" + request.getContextPath() + "/user/ticket-manager?page=0&amountPerPage=" + amountPerPage + "&searchOption=" + searchOption + "&searchByProductName=" + searchByProductName + "\">" +
                            ...
                            for(int j=currentPage-a; j<=currentPage+b; j++) {
                                if(j==currentPage) {
                                    out.println("<a href=\"" + request.getContextPath() + "/user/ticket-manager?page=" + j + "&amountPerPage=" + amountPerPage + "&searchOption=" + searchOption + "&searchByProductName=" + searchByProductName + "\">" +
                            ...
                            if(currentPage==pagesToPrint-1){
                                out.println("<a href=\"" + request.getContextPath() + "/user/ticket-manager?page=" + (pagesToPrint - 1) + "&amountPerPage=" + amountPerPage + "&searchOption=" + searchOption + "&searchByProductName=" + searchByProductName + "\">" +
